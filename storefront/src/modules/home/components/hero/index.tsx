  ...
  return (
    <div className="h-[75vh] w-full border-b border-ui-border-base relative bg-ui-bg-subtle">
      ...
      <section className="bg-gray-50 py-24 sm:py-32">
          <div className="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
            ...
            <div className="mt-10 grid gap-4 sm:mt-16 lg:grid-cols-3 lg:grid-rows-2">
              ...
              <div className="relative lg:row-span-2">
                ...
                <div className="relative flex h-full flex-col overflow-hidden rounded-lg lg:rounded-l-[2rem]">
                  <div className="px-8 pt-8 pb-3 sm:px-10 sm:pt-10">
                    <p className="text-lg font-medium tracking-tight text-gray-950 text-center">Mobile friendly</p>
                  ...
                  <div className="relative min-h-[30rem] w-full grow max-lg:mx-auto max-lg:max-w-sm">
                    <img
                      className="absolute inset-x-10 top-10 bottom-0 overflow-hidden rounded-t-[12cqw] border-gray-700 bg-gray-900 shadow-2xl"
                      src="https://tailwindcss.com/plus-assets/img/component-images/bento-03-mobile-friendly.png"
                      alt="Mobile-friendly UI preview"
                    />
                  </div>
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <div className="relative flex h-full flex-col overflow-hidden rounded-lg">
                  <div className="px-8 pt-8 sm:px-10 sm:pt-10">
                    <p className="text-lg font-medium tracking-tight text-gray-950 text-center">Performance</p>
                    <p className="mt-2 max-w-lg text-sm text-gray-600 text-center">
              ...
              <div className="relative">
                ...
                <div className="relative flex h-full flex-col overflow-hidden rounded-lg">
                  <div className="px-8 pt-8 sm:px-10 sm:pt-10">
                    <p className="text-lg font-medium tracking-tight text-gray-950 text-center">Security</p>
                    <p className="mt-2 max-w-lg text-sm text-gray-600 text-center">
              ...
              <div className="relative lg:row-span-2">
                ...
                <div className="relative flex h-full flex-col overflow-hidden rounded-lg lg:rounded-r-[2rem]">
                  <div className="px-8 pt-8 pb-3 sm:px-10 sm:pt-10">
                    <p className="text-lg font-medium tracking-tight text-gray-950 text-center">Powerful APIs</p>
                    <p className="mt-2 max-w-lg text-sm text-gray-600 text-center">
        ...
        <a href="https://funkyton.com/medusajs-2-0-is-finally-here/" target="_blank" className="underline text-blue-600">
          Visit the tutorial
        </a>
      </div>
    </div>
